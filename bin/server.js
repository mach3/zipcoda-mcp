...
server.tool("search_by_zipcode", "郵便番号から住所を検索するツール", {
...
server.tool("search_by_address", "住所から郵便番号を検索するツール", {
...
server.resource("zipcode_address_api", "postal://zipcode-address/api", { mimeType: "application/json" }, async () => {
    return {
        contents: [
            {
